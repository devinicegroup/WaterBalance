...
struct Settings {
    ...
    private let notifications = [
        SettingsModel(name: SettingsName.stopNotificationsAfter.rawValue,
                     ...
                     id: 3,
                     subtitle: nil,
                     toggle: UserDefaults.standard.bool(forKey: DateNotificationsEnum.stopNotification.rawValue)),
        SettingsModel(name: SettingsName.stratNotifications.rawValue,
                     ...
                     type: .sublabel,
                     id: 4,
                     subtitle: UserDefaults.standard.string(forKey: DateNotificationsEnum.startDate.rawValue),
                     toggle: nil),
        SettingsModel(name: SettingsName.finishNotifications.rawValue,
                     ...
                     type: .sublabel,
                     id: 5,
                     subtitle: UserDefaults.standard.string(forKey: DateNotificationsEnum.endDate.rawValue),
                     toggle: nil),
        SettingsModel(name: SettingsName.periodOfNotifications.rawValue,
                     ...
                     type: .sublabel,
                     id: 6,
                     subtitle: TimeInterval(UserDefaults.standard.double(forKey: DateNotificationsEnum.dateInterval.rawValue)).formatted,
                     toggle: nil)
    ]
    ...
    private let settings = [
        SettingsModel(name: SettingsName.appleHealth.rawValue,
                     ...
                     id: 7,
                     subtitle: nil,
                     toggle: UserDefaults.standard.bool(forKey: "health")),
        SettingsModel(name: SettingsName.sex.rawValue,
                     ...
                     type: .sublabel,
                     id: 8,
                     subtitle: UserDefaults.standard.string(forKey: "biologicalSex"),
                     toggle: nil),
        SettingsModel(name: SettingsName.weight.rawValue,
                     ...
                     type: .sublabel,
                     id: 9,
                     subtitle: "\(UserDefaults.standard.integer(forKey: "weight")) кг",
                     toggle: nil),
